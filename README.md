...
| `/russian/compositions/initials`                        | Б. Ю. Александров etc.                                | Б. Ю. Александров<br/>Narrow no-break space separated | Replaces regular spaces between initials and name with narrow no break spaces ` `                                                  |
